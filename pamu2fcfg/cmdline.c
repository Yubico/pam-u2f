...
const char *gengetopt_args_info_purpose =
    "Perform a U2F registration operation and print a configuration line that can be\nused with the pam_u2f module.";
...
int
cmdline_parser2(int argc, char **argv,
                        ...
                        const char *additional_error)
{
  ...
  while (1) {
    ...
    case 'i':                  /* Application ID to use. Defaults to pam://hostname.  */
      ...
      if (update_arg((void *) &(args_info->appid_arg),
                     ...
                     &(local_args_info.appid_given), optarg, 0, 0,
                     ARG_STRING, check_ambiguity, override, 0, 0, "appid",
                     'i', additional_error))
        goto failure;
    ...
    case 'd':                  /* Print debug information to standard error.  */
      ...
      if (update_arg
          ((void *) &(args_info->debug_flag), 0, &(args_info->debug_given),
    ...
    default:                   /* bug: option not considered.  */
      fprintf(stderr, "%s: option unknown: %c%s\n", CMDLINE_PARSER_PACKAGE,
              c, (additional_error ? additional_error : ""));
      abort();
    }                           /* switch */
  }                             /* while */
  ...
  if (args_info->user_group_counter > 1) {
    fprintf(stderr,
            "%s: %d options of group user were given. At most one is required%s.\n",
