...
const char *gengetopt_args_info_purpose =
  "Perform a U2F registration operation and print a configuration line that "
...
const char *gengetopt_args_info_help[] =
  {"  -h, --help             Print help and exit",
   ...
   "  -o, --origin=STRING    Origin URL to use during registration. Defaults "
   "to\n                           pam://hostname",
   "  -i, --appid=STRING     Application ID to use during registration. "
   "Defaults to\n                           pam://hostname",
   "  -d, --debug            Print debug information (highly verbose)\n        "
   "                   (default=off)",
   "  -v, --verbose          Print information about chosen origin and appid\n "
   "                          (default=off)",
   "\n Group: user", "  -u, --username=STRING  The name of the user "
                     "registering the device. Defaults\n                       "
                     "    to the current user name",
   "  -n, --nouser           Print only registration information (keyHandle "
   "and\n                           public key). Useful for appending",
   0};

typedef enum { ARG_NO, ARG_FLAG, ARG_STRING } cmdline_parser_arg_type;
...
static void reset_group_user(struct gengetopt_args_info *args_info) {
...
int cmdline_parser_internal(int argc, char **argv,
    ...
    switch (c) {
      case 'h': /* Print help and exit.  */
        ...
        if (update_arg(0, 0, &(args_info->help_given),
                       ...
                       check_ambiguity, override, 0, 0, "help", 'h',
                       additional_error))
          goto failure;
      ...
      case 'o': /* Origin URL to use during registration. Defaults to
                   pam://hostname.  */
        ...
        if (update_arg((void *)&(args_info->origin_arg),
                       ...
                       ARG_STRING, check_ambiguity, override, 0, 0, "origin",
                       'o', additional_error))
          goto failure;

        break;
      case 'i': /* Application ID to use during registration. Defaults to
                   pam://hostname.  */
        ...
        if (update_arg((void *)&(args_info->appid_arg),
                       ...
                       check_ambiguity, override, 0, 0, "appid", 'i',
                       additional_error))
          goto failure;
      ...
      case 'v': /* Print information about chosen origin and appid.  */
        ...
        break;
      case 'u': /* The name of the user registering the device. Defaults to the
                   current user name.  */
        ...
        if (update_arg((void *)&(args_info->username_arg),
                       &(args_info->username_orig),
                       &(args_info->username_given),
                       &(local_args_info.username_given), optarg, 0, 0,
                       ARG_STRING, check_ambiguity, override, 0, 0, "username",
                       'u', additional_error))
          goto failure;

        break;
      case 'n': /* Print only registration information (keyHandle and public
                   key). Useful for appending.  */

        if (args_info->user_group_counter && override)
          reset_group_user(args_info);
        args_info->user_group_counter += 1;

        if (update_arg(0, 0, &(args_info->nouser_given),
                       &(local_args_info.nouser_given), optarg, 0, 0, ARG_NO,
                       check_ambiguity, override, 0, 0, "nouser", 'n',
                       additional_error))
          goto failure;
  ...
  if (args_info->user_group_counter > 1) {
    fprintf(stderr, "%s: %d options of group user were given. At most one is "
                    "required%s.\n",
            argv[0], args_info->user_group_counter,
            (additional_error ? additional_error : ""));
    error_occurred = 1;
  }
