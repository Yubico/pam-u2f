...
struct gengetopt_args_info
{
  ...
  const char *origin_help; /**< @brief Origin URL to use. Defaults to pam://hostname help description.  */
  ...
  const char *appid_help; /**< @brief Application ID to use. Defaults to pam://hostname help description.  */
  ...
  const char *nouser_help; /**< @brief Print only registration information (keyHandle and public key) help description.  */
